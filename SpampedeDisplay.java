...
class SpampedeDisplay {
	...
	public void updateGraphics() {
		...
		int spaceInWidth = (this.width - Preferences.NUM_CELLS_WIDE * Preferences.CELL_SIZE)
				/(Preferences.CELL_SIZE * 2);
		for (int y = 0; y < Preferences.NUM_CELLS_TALL; y++) {
			for (int x = 0; x < Preferences.NUM_CELLS_WIDE; x++) {
				this.drawSquare( (x+spaceInWidth) * Preferences.CELL_SIZE, (y+spaceInWidth) * 
						Preferences.CELL_SIZE, this.theData.getCellColor(y,x));
			}
		}
